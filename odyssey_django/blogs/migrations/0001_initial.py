# Generated by Django 3.2.4 on 2021-07-19 04:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disliked_users', models.ManyToManyField(related_name='dislikedcomments', to='traveller_api.Traveller')),
                ('liked_users', models.ManyToManyField(related_name='likedcomments', to='traveller_api.Traveller')),
